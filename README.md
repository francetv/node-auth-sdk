...
You need to send a request to an API, but you cannot send it directly.

First, this package will grab a Client Token, that identifies the application you are currenlty developping. Let's say it's called `myApplication`.
...
Next, this package will grab the User Token, that identifies the current user of the application.
...
And finally, your initial request is sent with these two headers:
```
'X-Ftven-Id': 'id: myApplication, expire: 2014-12-10T14:16:21+0100, token: OTIxZjkzOGY4MjY4NzFhYz2ZDU53OTY1ZjE2ZGEzOWQxNDRjMWQwNQ=='
'X-Ftven-User': 'id: john.doe, expire: 2014-12-10T14:16:21+0100, token: Yzg2YjA0MWNiNmFlZDc0YzVjZGM2OT3RhYzFiOD5NTAzNjI2MmMwMw=='
```
